const builder = require('botbuilder'),
    factory = require('./../helpers/mongo_provider.js');
    ...
    function (session, results, next) {
        if (results.response) {
            ...
            factory.FindUser(UN, PW)
                .then((res) => {
                    if (res === null) session.endDialog("Sorry that username or password does not match")
                    ...
                    if (res === true) {
                        ...
                        session.endDialog("Sorry that username or password does not match")
                    }
                }).catch((err) => {
                    console.log(err)
                })
